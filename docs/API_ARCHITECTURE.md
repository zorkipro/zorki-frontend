...
- TokenManager - только токены
- ResponseHandler - только ответы
- ApiErrorHandler - только ошибки

### 2. **Тестируемость**
- Каждый модуль можно тестировать независимо
- Легко мокировать зависимости
- Singleton pattern для удобства тестирования
...
- Можно заменить модуль без изменения API
- Следование Open/Closed Principle
