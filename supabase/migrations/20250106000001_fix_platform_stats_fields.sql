-- ============================================================================
-- МИГРАЦИЯ: Исправление get_visible_bloggers
-- Дата: 2025-01-06
-- Цель: Добавить post_reach, story_reach, profile_url в platform_stats
-- Статус: ✅ УСПЕШНО ПРИМЕНЕНА
-- ============================================================================

-- Исправляем функцию get_blogger_data_with_edits - добавляем недостающие поля
-- post_reach, story_reach, engagement_rate, profile_url

DROP FUNCTION IF EXISTS public.get_visible_bloggers();
DROP FUNCTION IF EXISTS public.get_blogger_data_with_edits();
...
-- Пересоздаём функцию get_visible_bloggers с новым полем
