-- Восстановление блогеров в удаленной базе данных
-- Эта миграция добавляет всех блогеров из bloggers_data.json

-- Создаем записи в таблице influencers
...
-- Добавляем темы для блогеров (только если еще не добавлены)
INSERT INTO public.influencer_topics (influencer_id, topic_id) 
SELECT 
    '11111111-1111-1111-1111-111111111111'::uuid,
    (SELECT id FROM public.topics WHERE title = 'Красота и мода' LIMIT 1)
WHERE NOT EXISTS (
    SELECT 1 FROM public.influencer_topics 
    WHERE influencer_id = '11111111-1111-1111-1111-111111111111'::uuid
);

INSERT INTO public.influencer_topics (influencer_id, topic_id) 
SELECT 
    '22222222-2222-2222-2222-222222222222'::uuid,
    (SELECT id FROM public.topics WHERE title = 'Технологии' LIMIT 1)
WHERE NOT EXISTS (
    SELECT 1 FROM public.influencer_topics 
    WHERE influencer_id = '22222222-2222-2222-2222-222222222222'::uuid
);

INSERT INTO public.influencer_topics (influencer_id, topic_id) 
SELECT 
    '33333333-3333-3333-3333-333333333333'::uuid,
    (SELECT id FROM public.topics WHERE title = 'Здоровье и фитнес' LIMIT 1)
WHERE NOT EXISTS (
    SELECT 1 FROM public.influencer_topics 
    WHERE influencer_id = '33333333-3333-3333-3333-333333333333'::uuid
);

INSERT INTO public.influencer_topics (influencer_id, topic_id) 
SELECT 
    '44444444-4444-4444-4444-444444444444'::uuid,
    (SELECT id FROM public.topics WHERE title = 'Путешествия' LIMIT 1)
WHERE NOT EXISTS (
    SELECT 1 FROM public.influencer_topics 
    WHERE influencer_id = '44444444-4444-4444-4444-444444444444'::uuid
);

INSERT INTO public.influencer_topics (influencer_id, topic_id) 
SELECT 
    '55555555-5555-5555-5555-555555555555'::uuid,
    (SELECT id FROM public.topics WHERE title = 'Еда и рецепты' LIMIT 1)
WHERE NOT EXISTS (
    SELECT 1 FROM public.influencer_topics 
    WHERE influencer_id = '55555555-5555-5555-5555-555555555555'::uuid
);

INSERT INTO public.influencer_topics (influencer_id, topic_id) 
SELECT 
    '66666666-6666-6666-6666-666666666666'::uuid,
    (SELECT id FROM public.topics WHERE title = 'Спорт' LIMIT 1)
WHERE NOT EXISTS (
    SELECT 1 FROM public.influencer_topics 
    WHERE influencer_id = '66666666-6666-6666-6666-666666666666'::uuid
);

INSERT INTO public.influencer_topics (influencer_id, topic_id) 
SELECT 
    '77777777-7777-7777-7777-777777777777'::uuid,
    (SELECT id FROM public.topics WHERE title = 'Дети и семья' LIMIT 1)
WHERE NOT EXISTS (
    SELECT 1 FROM public.influencer_topics 
    WHERE influencer_id = '77777777-7777-7777-7777-777777777777'::uuid
);

INSERT INTO public.influencer_topics (influencer_id, topic_id) 
SELECT 
    '88888888-8888-8888-8888-888888888888'::uuid,
    (SELECT id FROM public.topics WHERE title = 'Бизнес' LIMIT 1)
WHERE NOT EXISTS (
    SELECT 1 FROM public.influencer_topics 
    WHERE influencer_id = '88888888-8888-8888-8888-888888888888'::uuid
);

INSERT INTO public.influencer_topics (influencer_id, topic_id) 
SELECT 
    '99999999-9999-9999-9999-999999999999'::uuid,
    (SELECT id FROM public.topics WHERE title = 'Психология' LIMIT 1)
WHERE NOT EXISTS (
    SELECT 1 FROM public.influencer_topics 
    WHERE influencer_id = '99999999-9999-9999-9999-999999999999'::uuid
);

INSERT INTO public.influencer_topics (influencer_id, topic_id) 
SELECT 
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa'::uuid,
    (SELECT id FROM public.topics WHERE title = 'Автомобили' LIMIT 1)
WHERE NOT EXISTS (
    SELECT 1 FROM public.influencer_topics 
    WHERE influencer_id = 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa'::uuid
);
