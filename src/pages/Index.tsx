    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className="hidden lg:block lg:w-80 flex-shrink-0 fixed top-16 left-4 z-10 max-h-[calc(100vh-4rem)] overflow-y-auto" aria-label="Фильтры поиска">
          ...
          <div className="flex-1 lg:ml-[21rem]">
            <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-foreground">Рейтинг блогеров</h1>
              ...
              <div className="flex items-center gap-2">
                ...
                <Sheet open={isFilterOpen} onOpenChange={handleFilterToggle}>
                  ...
                  <SheetContent side="left" className="w-80 p-0" aria-label="Панель фильтров">
                    <FilterSidebar
                      filters={filters}
