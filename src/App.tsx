...
const BloggerProfile = lazy(() =>
  import('./pages/BloggerProfile').then((module) => ({ default: module.BloggerProfile }))
);
const ProfileEditor = lazy(() =>
  import('./pages/ProfileEditor').then((module) => ({ default: module.ProfileEditor }))
);
...
const EmailConfirmation = lazy(() =>
  import('./pages/EmailConfirmation').then((module) => ({ default: module.EmailConfirmation }))
);
