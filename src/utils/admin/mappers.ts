 ...
 */
export const mapLinkRequestToTableFormat = (
  request: AdminGetLinkBloggerClientRequestOutputDto,
) => {
  const mainSocial =
  ...
  return {
    ...
    followers: mainSocial?.subscribers
      ? parseInt(mainSocial.subscribers) || 0
      : 0,
