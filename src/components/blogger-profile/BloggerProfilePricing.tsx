      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          {Object.entries(blogger.platforms)
            ...
            .map(([platform, stats]) => (
              <div key={platform} className="border-b border-border-light pb-3 last:border-b-0">
                ...
                <div className="space-y-1 text-sm">
                  ...
                  {platform === 'instagram' && stats.storyPrice && (
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{stats.storyPrice || 0} BYN</span>
                    </div>
                  )}
                </div>
              </div>
        ...
        <CardContent className="space-y-4">
          <div>
            <p className="text-sm text-muted-foreground">
              {blogger.cooperationConditions || 'Условия сотрудничества не указаны.'}
            </p>
          </div>
