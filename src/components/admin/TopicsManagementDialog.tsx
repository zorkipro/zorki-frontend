...
import type { TopicsOutputDto, AdminCreateTopicInputDto, AdminUpdateTopicInputDto } from '@/api/types';
          ...
          <div className="flex flex-col flex-1 min-h-0">
            ...
            {showForm && (
              <Card className="mb-6">
                <CardHeader>
                  <CardTitle>
                    {editingTopic ? 'Редактировать топик' : 'Создать новый топик'}
                  </CardTitle>
                </CardHeader>
            ...
            <Tabs defaultValue="normal" className="flex-1 flex flex-col">
              ...
              <TabsContent value="normal" className="mt-4 flex-1 overflow-auto max-h-[400px]">
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <h3 className="text-lg font-medium">Обычные топики</h3>
                    <Button onClick={handleCreateTopic} disabled={loadingTopics}>
              ...
              <TabsContent value="restricted" className="mt-4 flex-1 overflow-auto max-h-[400px]">
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Вы уверены, что хотите удалить топик "{deletingTopic?.name}"? 
