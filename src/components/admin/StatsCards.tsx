    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-6 mb-6 lg:mb-8">
      <Card className="p-3 lg:p-6">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 p-0">
          <CardTitle className="text-xs lg:text-sm font-medium">Всего блогеров</CardTitle>
          <Users className="h-3 w-3 lg:h-4 lg:w-4 text-muted-foreground" />
        </CardHeader>
        <CardContent className="p-0 pt-2">
          <div className="text-lg lg:text-2xl font-bold">{stats.totalBloggersCount}</div>
        </CardContent>
      </Card>

      <Card className="p-3 lg:p-6">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 p-0">
          <CardTitle className="text-xs lg:text-sm font-medium">Одобрено</CardTitle>
      ...
      <Card className="p-3 lg:p-6">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 p-0">
          <CardTitle className="text-xs lg:text-sm font-medium">Запросы</CardTitle>
      ...
      <Card className="p-3 lg:p-6">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 p-0">
          <CardTitle className="text-xs lg:text-sm font-medium">Видимых</CardTitle>
