 ...
 */
export const CooperationTermsSection: React.FC<CooperationTermsSectionProps> = React.memo(
  ({
      ...
      <CardContent className="p-4">
        <div className="absolute top-2 right-2">
          <Dialog
            ...
            onOpenChange={(open) => onEditingSectionChange(open ? 'cooperation_conditions' : null)}
          >
