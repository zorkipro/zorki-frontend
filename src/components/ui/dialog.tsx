  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "left-1/2 top-[10%] -translate-x-1/2 w-[calc(100%-2rem)] max-h-[80vh] overflow-y-auto p-4 rounded-lg",
        "sm:top-[50%] sm:-translate-y-1/2 sm:w-full sm:max-w-lg sm:max-h-[90vh] sm:p-6 sm:rounded-lg",
